...
cbimport json --cluster couchbase://${host} --bucket mdata --username ${user} --password ${pwd} --format list --generate-key %id% --dataset file:///${HOME}/VxData/MatsMetadataAndIndexes/metadata_files/ingest_stations_and_obs.json
